      ...
      <div className="w-[60%] pt-[225px] pl-[90px]">
        ...
        <div>
          ...
          <div class="relative my-[34px]">
            <input type="text" id="floating_outlined2" class="block px-[26px] py-[26px] xl:w-[368px] text-xl text-secondary font-semibold bg-transparent rounded-lg border-1 border-gray-300 appearance-none   focus:outline-none focus:ring-0 focus:border-secondary/30 peer" placeholder=" " />
